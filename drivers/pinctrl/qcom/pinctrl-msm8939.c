...
static const struct pinctrl_pin_desc msm8939_pins[] = {
...
static const struct msm_pinctrl_soc_data msm8939_pinctrl = {
	.pins = msm8939_pins,
	.npins = ARRAY_SIZE(msm8939_pins),
	.functions = msm8939_functions,
	.nfunctions = ARRAY_SIZE(msm8939_functions),
	.groups = msm8939_groups,
	.ngroups = ARRAY_SIZE(msm8939_groups),
	.ngpios = 122,
};

static int msm8939_pinctrl_probe(struct platform_device *pdev)
{
	return msm_pinctrl_probe(pdev, &msm8939_pinctrl);
}

static const struct of_device_id msm8939_pinctrl_of_match[] = {
	{ .compatible = "qcom,msm8939-pinctrl", },
	{ },
};

static struct platform_driver msm8939_pinctrl_driver = {
	.driver = {
		.name = "msm8939-pinctrl",
		.owner = THIS_MODULE,
		.of_match_table = msm8939_pinctrl_of_match,
	},
	.probe = msm8939_pinctrl_probe,
	.remove = msm_pinctrl_remove,
};

static int __init msm8939_pinctrl_init(void)
{
	return platform_driver_register(&msm8939_pinctrl_driver);
}
arch_initcall(msm8939_pinctrl_init);

static void __exit msm8939_pinctrl_exit(void)
{
	platform_driver_unregister(&msm8939_pinctrl_driver);
}
module_exit(msm8939_pinctrl_exit);

MODULE_DESCRIPTION("Qualcomm msm8939 pinctrl driver");
MODULE_LICENSE("GPL v2");
MODULE_DEVICE_TABLE(of, msm8939_pinctrl_of_match);
